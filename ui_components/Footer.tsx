...
const Footer = () => {
  ...
  return (
    <>
      <div className="mb-16 pt-8 text-center text-sm text-secondary md:border-t md:border-t-cyan-500/50 md:mask-[linear-gradient(to_right,transparent,black,transparent)]">
